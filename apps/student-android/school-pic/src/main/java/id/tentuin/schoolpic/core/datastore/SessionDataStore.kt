package id.tentuin.schoolpic.core.datastore
...
private val Context.sessionDataStore by preferencesDataStore(name = "school_pic_session")
...
class SessionDataStore(private val context: Context) {
    ...
    val schoolId:     Flow<String?> = store.data.map { it[KEY_SCHOOL_ID] }
    ...
    suspend fun saveSchoolId(schoolId: String) {
        store.edit { it[KEY_SCHOOL_ID] = schoolId }
    }
